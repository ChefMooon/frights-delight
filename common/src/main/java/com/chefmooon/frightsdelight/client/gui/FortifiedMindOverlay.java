...
public class FortifiedMindOverlay {
    public static void renderFortifiedMindOverlay(Minecraft mc, PoseStack poseStack, int foodIconsOffset) {
        ...
        if (player.getEffect(FrightsDelightEffects.FORTIFIED_MIND.get()) != null) {
            FrightsDelightGUI.renderNegativeHungerOverlay(FrightsDelightGUI.HungerType.FORTIFIED_MIND, player, mc, poseStack, left, top);
        }
    }
