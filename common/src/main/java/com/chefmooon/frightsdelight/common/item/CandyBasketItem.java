...
public class CandyBasketItem extends BlockItem {
    ...
    public InteractionResult shuffleItems(Level level, Player player, ItemStack basketStack) {
    ...
    public InteractionResult removeItem(Level level, Player player, InteractionHand offHand, ItemStack basketStack, ItemStack offHandStack) {
        ItemContainerContents items = basketStack.get(DataComponents.CONTAINER);
    ...
    public InteractionResult addItem(Level level, Player player, ItemStack basketStack, ItemStack offHandStack) {
        if (!offHandStack.has(DataComponents.FOOD)) return InteractionResult.FAIL;
        ItemContainerContents items = basketStack.get(DataComponents.CONTAINER);
