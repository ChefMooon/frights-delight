...
public class FoodValues {
    ...
    public static final FoodProperties ROTTEN_FLESH_PIE_SLICE = foodProperty(4, 0.3f, true, true, false,
            List.of(new MobEffectInfo(INFECTED, SHORT_DURATION, .5f)));
    public static final FoodProperties SLIMEAPPLE_PIE_SLICE = foodProperty(4, 0.3f, false, true, false,
            List.of(new MobEffectInfo(SLIMED, SHORT_DURATION, .5f)));
    public static final FoodProperties SPIDEREYE_PIE_SLICE = foodProperty(4, 0.3f, false, true, false,
            List.of(new MobEffectInfo(HYSTERIA, SHORT_DURATION, .5f)));
    public static final FoodProperties GHASTTEAR_PIE_SLICE = foodProperty(4, 0.3f, false, true, false,
            List.of(new MobEffectInfo(CHILLS, SHORT_DURATION, .5f)));
    public static final FoodProperties SOUL_BERRY_CHEESECAKE_SLICE = foodProperty(4, 0.3f, false, true, true,
            List.of(new MobEffectInfo(FORTIFIED_MIND, SHORT_DURATION, 1.0f)));
    public static final FoodProperties WITHER_BERRY_CHEESECAKE_SLICE = foodProperty(4, 0.3f, false, true, true,
            List.of(new MobEffectInfo(UNDEAD_HUNGER, SHORT_DURATION, 1.0f)));
    public static final FoodProperties COBWEB_PIE_SLICE = foodProperty(4, 0.3f, false, true, false,
    ...
    public static final FoodProperties ROTTEN_FLESH_LOLLIPOP = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(INFECTED, BRIEF_DURATION, .25f)));
    public static final FoodProperties SLIMEAPPLE_LOLLIPOP = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(SLIMED, BRIEF_DURATION, .25f)));
    public static final FoodProperties SPIDEREYE_LOLLIPOP = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(HYSTERIA, BRIEF_DURATION, .25f)));
    public static final FoodProperties GHASTTEAR_LOLLIPOP = foodProperty(2, 0.1f, false, true, false,
            List.of(new MobEffectInfo(CHILLS, BRIEF_DURATION, .25f)));
    public static final FoodProperties SOUL_BERRY_LOLLIPOP = foodProperty(2, 0.1f, false, true, true,
            List.of(new MobEffectInfo(FORTIFIED_MIND, MEDIUM_DURATION, 1.0f)));
    public static final FoodProperties WITHER_BERRY_LOLLIPOP = foodProperty(2, 0.1f, false, true, true,
            List.of(new MobEffectInfo(UNDEAD_HUNGER, MEDIUM_DURATION, 1.0f)));
    public static final FoodProperties COBWEB_LOLLIPOP = foodProperty(2, 0.1f, false, true, false,
            List.of(new MobEffectInfo(COBWEBBED, BRIEF_DURATION, .25f)));

    // *** RING CANDY *** //

    public static final FoodProperties ROTTEN_FLESH_RING_CANDY = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(INFECTED, BRIEF_DURATION, .25f)));
    public static final FoodProperties SLIMEAPPLE_RING_CANDY = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(SLIMED, BRIEF_DURATION, .25f)));
    public static final FoodProperties SPIDEREYE_RING_CANDY = foodProperty(2, 0.1f, true, true, false,
            List.of(new MobEffectInfo(HYSTERIA, BRIEF_DURATION, .25f)));
    public static final FoodProperties GHASTTEAR_RING_CANDY = foodProperty(2, 0.1f, false, true, false,
            List.of(new MobEffectInfo(CHILLS, BRIEF_DURATION, .25f)));
    public static final FoodProperties SOUL_BERRY_RING_CANDY = foodProperty(2, 0.1f, false, true, true,
            List.of(new MobEffectInfo(FORTIFIED_MIND, MEDIUM_DURATION, 1.0f)));
    public static final FoodProperties WITHER_BERRY_RING_CANDY = foodProperty(2, 0.1f, false, true, true,
            List.of(new MobEffectInfo(UNDEAD_HUNGER, MEDIUM_DURATION, 1.0f)));
    public static final FoodProperties COBWEB_RING_CANDY = foodProperty(2, 0.1f, false, true, false,
            List.of(new MobEffectInfo(COBWEBBED, BRIEF_DURATION, .25f)));
