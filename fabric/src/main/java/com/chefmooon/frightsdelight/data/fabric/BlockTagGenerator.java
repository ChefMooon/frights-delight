...
public class BlockTagGenerator extends FabricTagProvider.BlockTagProvider {
    ...
    private void registerCommonBlockTags() {
        getOrCreateTagBuilder(CommonTags.C_MINEABLE_KNIFE)
                .add(FrightsDelightBlocksImpl.MELON_CANDY_BASKET)
                .add(FrightsDelightBlocksImpl.PUMPKIN_CANDY_BASKET)
                .add(FrightsDelightBlocksImpl.JACK_O_LANTERN_CANDY_BASKET)
                ...
                .add(FrightsDelightBlocksImpl.ROTTEN_FLESH_PIE)
                .add(FrightsDelightBlocksImpl.SLIMEAPPLE_PIE)
                .add(FrightsDelightBlocksImpl.SPIDEREYE_PIE)
                .add(FrightsDelightBlocksImpl.GHASTTEAR_PIE)
                .add(FrightsDelightBlocksImpl.SOUL_BERRY_CHEESECAKE)
                .add(FrightsDelightBlocksImpl.WITHER_BERRY_CHEESECAKE)
                .add(FrightsDelightBlocksImpl.COBWEB_PIE);
    ...
    private void registerMinecraftBlockTags() {
        getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(FrightsDelightBlocksImpl.LOLLIPOP_MOLD)
                .add(FrightsDelightBlocksImpl.RING_CANDY_MOLD);
