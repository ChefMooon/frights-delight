    ...
    public void generateAdvancement(Consumer<Advancement> consumer) {
         Advancement root = Advancement.Builder.advancement()
                .display(FrightsDelightItemsImpl.APPLE_SLIME,
                        ...
                        ResourceLocation.tryBuild(ResourceLocation.DEFAULT_NAMESPACE, "textures/block/soul_sand.png"),
        ...
        Advancement getMonsterDrop = getAdvancement(root, Items.COBWEB, "get_monster_drop", FrameType.TASK, true, true, false)
        ...
        Advancement craftCookie = getAdvancement(getMonsterDrop, FrightsDelightItemsImpl.COOKIE_ROTTEN_FLESH, "craft_cookie", FrameType.TASK, true, true, false)
        ...
        Advancement craftBest = getAdvancement(craftCookie, FrightsDelightItemsImpl.PASTA_WITH_SLIMEBALLS, "craft_best", FrameType.TASK, true, true, false)
        ...
        Advancement craftBoneShard = getAdvancement(root, FrightsDelightItemsImpl.BONE_SHARD, "craft_bone_shard", FrameType.TASK, true, true, false)
        ...
        Advancement hitSkeletonWithBoneShard = getAdvancement(craftBoneShard, FrightsDelightItemsImpl.BONE_SHARD, "hit_skeleton_with_bone_shard", FrameType.TASK, true, true, false)
        ...
        Advancement getSoulBerry = getAdvancement(root, FrightsDelightItemsImpl.SOUL_BERRY, "get_soul_berry", FrameType.TASK, true, true, false)
        ...
        Advancement getWitherBerry = getAdvancement(getSoulBerry, FrightsDelightItemsImpl.WITHER_BERRY, "get_wither_berry", FrameType.TASK, true, true, false)
        ...
        Advancement craftPunchBowl = getAdvancement(root, FrightsDelightItemsImpl.PUNCH_SPIDEREYE, "craft_punchbowl", FrameType.TASK, true, true, false)
        ...
        Advancement candySyrup = getAdvancement(root, FrightsDelightItemsImpl.ROTTEN_FLESH_SYRUP_BOTTLE, "craft_candy_syrup", FrameType.TASK, true, true, false)
        ...
        Advancement lollipopMold = getAdvancement(candySyrup, FrightsDelightItemsImpl.LOLLIPOP_MOLD, "craft_lollipop_mold", FrameType.TASK, true, true, false)
        ...
        Advancement lollipopLollipop = getAdvancement( lollipopMold, FrightsDelightItemsImpl.SOUL_BERRY_LOLLIPOP, "craft_lollipop_lollipop", FrameType.TASK, true, true, false)
        ...
        Advancement ringCandyMold = getAdvancement(candySyrup, FrightsDelightItemsImpl.RING_CANDY_MOLD, "craft_ring_candy_mold", FrameType.TASK, true, true, false)
        ...
        Advancement ringCandy = getAdvancement(ringCandyMold, FrightsDelightItemsImpl.WITHER_BERRY_RING_CANDY, "craft_ring_candy", FrameType.TASK, true, true, false)
        ...
        Advancement trickOrTreat = getAdvancement(root, FrightsDelightItemsImpl.PUMPKIN_CANDY_BASKET, "trick_or_treat", FrameType.TASK, true, true, false)
        ...
        Advancement mysteryCandy = getAdvancement(trickOrTreat, FrightsDelightItemsImpl.JACK_O_LANTERN_CANDY_BASKET, "mystery_candy", FrameType.TASK, true, true, false)
        ...
        Advancement frdMaster = getAdvancement(craftPunchBowl, FrightsDelightItemsImpl.PASTA_WITH_SLIMEBALLS, "frd_master", FrameType.CHALLENGE, true, true, false)
                ...
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.ROTTEN_FLESH_PIE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.ROTTEN_FLESH_PIE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.SLIMEAPPLE_PIE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.SLIMEAPPLE_PIE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.SPIDEREYE_PIE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.SPIDEREYE_PIE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.GHASTTEAR_PIE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.GHASTTEAR_PIE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.SOUL_BERRY_CHEESECAKE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.SOUL_BERRY_CHEESECAKE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.WITHER_BERRY_CHEESECAKE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.WITHER_BERRY_CHEESECAKE_SLICE))
                .addCriterion(RecipeProvider.getHasName(FrightsDelightItemsImpl.COBWEB_PIE_SLICE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.COBWEB_PIE_SLICE))
                .addCriterion(RecipeGenerator.getHasName(FrightsDelightItemsImpl.ROTTEN_FLESH_SYRUP_BOTTLE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.ROTTEN_FLESH_SYRUP_BOTTLE))
                .addCriterion(RecipeGenerator.getHasName(FrightsDelightItemsImpl.SPIDEREYE_SYRUP_BOTTLE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.SPIDEREYE_SYRUP_BOTTLE))
                .addCriterion(RecipeGenerator.getHasName(FrightsDelightItemsImpl.SLIMEAPPLE_SYRUP_BOTTLE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.SLIMEAPPLE_SYRUP_BOTTLE))
                .addCriterion(RecipeGenerator.getHasName(FrightsDelightItemsImpl.GHASTTEAR_SYRUP_BOTTLE), InventoryChangeTrigger.TriggerInstance.hasItems(FrightsDelightItemsImpl.GHASTTEAR_SYRUP_BOTTLE))
