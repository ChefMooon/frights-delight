...
public class FrightsDelightBiomeFeaturesImpl {
    ...
    public static final RegistryObject<Feature<WildBushConfiguration>> WILD_BUSH = FEATURES.register(FrightsDelightBiomeFeatures.WILD_BUSH.getPath(), () -> new WildBushFeature(WildBushConfiguration.CODEC));
